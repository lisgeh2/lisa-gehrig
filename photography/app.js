const sections = [
{title:'wandering around porto',label:'porto',story:'<strong>september 2023</strong>. I have just walked the camino the santiago and spent 4 weeks on a farm with travellers. On the last 2 days - I am alone. I spend the time conscious of what I have left behind, filling the emptiness in my heart with observation and photography.'},
...
{title:'europe',label:'europe',story:'<strong>2022</strong>. Ages 19-20 in my gap year, I travel europe with a cheap disposable camera. I wanted to live stories and not hunt pretty surfaces. Each of these have a story, a long and interesting one. but maybe, try to invent your own.'},

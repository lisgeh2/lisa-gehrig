const sections = [
{title:'wandering around porto',label:'porto',story:'**september 2023**. I have just walked the camino the santiago and spent 4 weeks on a farm with travellers. On the last 2 days - I am alone. I spend the time conscious of what I have left behind, filling the space in my heart with observation and photography.'},
{title:'rome in black and white',label:'rome',story:'march 2019. Gymnasium, everyone in the class is handed an old analog camera. Mine doesnt have any automatic mode, I handle shutterspeed and aperature first time solo.'},
{title:'makro',label:'makro',story:'I used to be an introverted kid. Id spend hours in the garden, the grass as high as myself. Observing. I was 15-16 taking these pictures. I used a bunch of tricks to make my camera able to focus so closely - and ofc - I had to spend hours and hours outside, patiently observing. The feeling that the next shot could be the perfect one always kept me going.'},
{title:'nepal - views',label:'nepal_views',story:'august 2024. I arrive my nepal and lose my whole pbackpack and meet a friend for life on the same day. 4rth image, a child who attends monastery school watches over kathmandu. 100 years ago, the city was far far away from the monastery. Now they touch. The city noise and dirty air reach up to the monastery. At some point the boy will have to go down there again. At some point, the monastery will be swallowed by the city. But not yet. Not yet.'},
{title:'nepal - streets',label:'nepal_streets',story:'august 2024. Around poverty, the naked desire to survive strikes me deeply. Sell 10 hours bananas a day. At 8 years old, skip school to run after tourists with a bucket. Humanity is there, plenty, but buried underneath hunger'},
{title:'europe',label:'europe',story:'Ages 19-20 in my gap year, I travel europe with a cheap one-way camera. I wanted to live stories and not hunt pretty surfaces. Each of these have a story, a long and interesting one. but maybe, try to invent your own.'},
{title:'morocco',label:'morocco',story:'october 2018. I am 16 and probably on the peak of photographic obsession. I had spent the past year trying to find beauty in the mundane grey life of zurich - and then my parents visited morocco with me. What an aesthetic paradise.'},
{title:'deserts',label:'deserts',story:'october 2028. At 16, I dont really engage with the culture or the people at all. But my compositions dare to be more simplistic, dare to leave space.'},
{title:'in the forrest',label:'forrest',story:'july 2023. Friends invite me to a "Waldbesetzung" in germany. People have unexpected genders, names that resemble bugs and cookies. Constructions are nowhere near safe, people smoke weed while drilling screws. Food rots on plates because nobody cleans it. But somehow - a refuge. Somehow -  a remarkable, admirable, pure heart'},
{title:'israel',label:'isreal',story:'march 2022. The first destiny of that gap year is israel. I to couchsurf in palestine and tel aviv to get to know both sides of the conflict. I find the diversity fascinating in jerusalem.'},
];
